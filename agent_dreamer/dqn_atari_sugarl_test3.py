...
if __name__ == "__main__":
    ...
    pvm_buffer_replay = PVMBuffer(args.pvm_stack, (envs.num_envs, args.frame_stack,)+OBSERVATION_SIZE)
    pvm_buffer_predict = PVMBuffer(args.pvm_stack, (envs.num_envs, args.frame_stack,)+OBSERVATION_SIZE)
    ...
    while global_transitions < args.total_timesteps:
        ...
        if random.random() < epsilon:
            ...
            with torch.no_grad():
                ...
                predicted_frame_tensor = atari_Decoder(obs_latent)
        ...
        if global_transitions % args.train_frequency == 0:
            ...
            pred_frame_loss = F.mse_loss(new_frame, next_obs_[:, [4], :, :])
